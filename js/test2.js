...
document.getElementById("start").addEventListener('click', initialize, false);
...
function initialize() {
    ...
    document.getElementById("fond").appendChild(ctx.canvas);
