...
Land = function(){
    ...
    let textureRoad = texture.load('https://nadiaessou.github.io/BDDI_project_webgl/img/route.png');
...
Moon = function(){
    ...
    var moonGeom = new THREE.CircleGeometry( 530, 80, 100 );
     ...
     let textureMoon = textureLoader.load('https://nadiaessou.github.io/BDDI_project_webgl/img/lune.png');
...
Sun = function(){
    ...
    var sunGeom = new THREE.CircleGeometry( 530, 80, 100 );
     ...
     let textureLoader = new THREE.TextureLoader();
     let textureSun = textureLoader.load('https://nadiaessou.github.io/BDDI_project_webgl/img/soleil.png');
...
Cloud = function(){
    ...
    let textureLoader = new THREE.TextureLoader();
    let texture = textureLoader.load('https://nadiaessou.github.io/BDDI_project_webgl/img/nuage.png');
...
Tree = function () {
    ...
    var matTreeLeaves = new THREE.MeshBasicMaterial( { color: "green"});
...
var Car = function() {
    ...
    let textureLoader = new THREE.TextureLoader();
    let texture = textureLoader.load('https://nadiaessou.github.io/BDDI_project_webgl/img/car.png');
...
var Roue = function(){
    ...
    let textureRoue = textureRoueLoader.load('https://nadiaessou.github.io/BDDI_project_webgl/img/roue.png');
...
var Maison = function(){
    ...
    var texturesMaison = [
        'https://nadiaessou.github.io/BDDI_project_webgl/img/maison.png',
        'https://nadiaessou.github.io/BDDI_project_webgl/img/maison2.png',
        'https://nadiaessou.github.io/BDDI_project_webgl/img/maison3.png',
    ];
